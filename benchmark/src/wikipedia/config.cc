...
DEFINE_string(wiki_workload_config_path, "/home/dakennguyen.linux/Workspace/leanstore/benchmark/src/wikipedia/summary.csv",
              "The CSV file which contains Wikipedia workload characteristics");
DEFINE_string(wiki_articles_path, "/home/dakennguyen.linux/Workspace/leanstore/benchmark/src/wikipedia/articles",
