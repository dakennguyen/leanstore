...
DEFINE_string(wiki_workload_config_path, "/root/projects/leanstore/benchmark/src/wikipedia/summary.csv",
              "The CSV file which contains Wikipedia workload characteristics");
DEFINE_string(wiki_articles_path, "/root/projects/leanstore/benchmark/src/wikipedia/articles",
